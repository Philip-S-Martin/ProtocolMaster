...
namespace ProtocolMaster.Model.Protocol.Driver
{
    ...
    internal class DriverManager : IDriverManager
    {
        ...
        public void Load()
        {
            ...
            {
                App.Window.TimelineView.ListDriver(i.Metadata);
            ...
            App.Window.TimelineView.ShowSelectedDriver();
        }
        ...
        public void Run(List<DriveData> data, Progress<DriverProgress> progress)
        {
            ...
            // Loop through driver
            App.Current.Dispatcher.Invoke(() => App.Window.TimelineView.StartAnimation());
            driver.Run();
            IsRunning = false;
